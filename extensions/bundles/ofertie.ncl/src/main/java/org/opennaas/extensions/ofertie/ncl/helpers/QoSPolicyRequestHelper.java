...
public abstract class QoSPolicyRequestHelper {
	...
	private static Jitter mergeJitter(Jitter originalJitter, Jitter updatedJitter) {
	...
	private static Throughput mergeThroughput(Throughput originalThroughput, Throughput updatedThroughput) {
	...
	private static Latency mergeLatency(Latency originalLatency, Latency updatedLatency) {
	...
	private static PacketLoss mergePacketLoss(PacketLoss originalPacketLoss, PacketLoss updatedPacketLoss) {
