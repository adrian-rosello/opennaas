 ...
 * 
 */
public class ConfigureRIPGroupAction extends JunosAction {

	private static final String	VELOCITY_TEMPLATE	= "/VM_files/ripConfigureGroup.vm";

	private static final String	PROTOCOL_NAME		= "netconf";

	public ConfigureRIPGroupAction() {
		setActionID(ActionConstants.RIP_CONFIGURE_GROUP);
