 ...
 * 
 */
public class RemoveInterfaceFromRIPGroup extends JunosAction {

	private static final String	VELOCITY_TEMPLATE	= "/VM_files/ripRemoveInterfaceFromGroup.vm";

	private static final String	PROTOCOL_NAME		= "netconf";

	public RemoveInterfaceFromRIPGroup() {
		setActionID(ActionConstants.RIP_REMOVE_INTERFACE_FROM_GROUP);
