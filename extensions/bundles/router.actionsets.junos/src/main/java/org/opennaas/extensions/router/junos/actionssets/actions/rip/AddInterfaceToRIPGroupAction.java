 ...
 * 
 */
public class AddInterfaceToRIPGroupAction extends JunosAction {

	private static final String	VELOCITY_TEMPLATE	= "/VM_files/ripAddInterfaceToGroup.vm";

	private static final String	PROTOCOL_NAME		= "netconf";

	public AddInterfaceToRIPGroupAction() {
		setActionID(ActionConstants.RIP_ADD_INTERFACE_TO_GROUP);
