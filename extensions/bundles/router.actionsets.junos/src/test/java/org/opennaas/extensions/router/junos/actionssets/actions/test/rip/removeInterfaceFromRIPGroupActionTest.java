 ...
 * 
 */
public class removeInterfaceFromRIPGroupActionTest {

	Log											log	= LogFactory.getLog(removeInterfaceFromRIPGroupActionTest.class);
	private static RemoveInterfaceFromRIPGroup	action;
	...
	public static void init() {
		...
		action = new RemoveInterfaceFromRIPGroup();
	...
	public void actionIDTest() {
		...
		Assert.assertEquals("Wrong ActionID", ActionConstants.RIP_REMOVE_INTERFACE_FROM_GROUP,
				action.getActionID());
	}
	...
	public void templateTest() {
		...
		Assert.assertEquals("Not accepted template", "/VM_files/ripRemoveInterfaceFromGroup.vm", action.getTemplate());
	}
	...
	public void executeActionTest() {
		...
		try {
			...
			Assert.assertTrue(response.getActionID()
					.equals(ActionConstants.RIP_REMOVE_INTERFACE_FROM_GROUP));
